const CACHE_VERSION = "koi-step36-auth-repair-v19";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=36",
  "./app.js?v=36",
  "./services/about-name.js?v=36",
  "./services/boot.js?v=36",
  "./data/data.js?v=36",
  "./services/app-update.js?v=36",
  "./config/supabase-config.js?v=36",
  "./services/supabase.js?v=36",
  "./services/auth.js?v=36",
  "./services/pairs.js?v=36",
  "./services/little-things.js?v=36",
  "./services/memories.js?v=36",
  "./services/shared-state.js?v=36",
  "./services/world.js?v=36",
  "./features/koi-world.js?v=36",
  "./services/push-notifications.js?v=36",
  "./services/koi-note.js?v=36",
  "./features/koi-note.js?v=36",
  "./services/chat.js?v=36",
  "./features/koi-chat.js?v=36",
  "./services/live-sync.js?v=36",
  "./services/sync.js?v=36",
  "./services/cloud-bootstrap.js?v=36",
  "./manifest.json",
  "./icon/icon-192.png",
  "./icon/icon-512.png",
